...
class DataFrameJoinsTest : SparkTestBase() {
    ...
    data class Person(var name: String = "", var age: Int = 0, var cityId: Int = 0)
    data class City(var id: Int = 0, var name: String = "")
    data class JoinedResult(var personName: String = "", var cityName: String? = null)
    ...
    fun `join() should perform various types of joins`() {
        ...
        val leftJoin = people.join(cities, col("people.cityId").equalTo(col("cities.id")), "left_outer")
