...
internal sealed class DuplicateSealedParent

internal class ContainerA {
    internal class Child : DuplicateSealedParent()
}

internal class ContainerB {
    internal class Child : DuplicateSealedParent()
}

private data class WithUnsupportedField(
    val thread: Thread,
)
