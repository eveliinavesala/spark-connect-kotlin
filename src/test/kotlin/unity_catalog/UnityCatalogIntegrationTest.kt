...
class UnityCatalogIntegrationTest : SparkTestBase() {
    ...
    companion object {
        ...
        fun ensureCatalogSetup() {
            ...
            val catalogCreated = UnityCatalogRestClient.createCatalog(
                baseUrl = baseUrl,
                name = "test_catalog",
                comment = "Test catalog for integration tests"
            )
            
            val schemaCreated = UnityCatalogRestClient.createSchema(
                baseUrl = baseUrl,
    ...
    fun `should verify Unity Catalog is accessible via REST API`() {
        ...
        assertTrue(catalogs.contains("test_catalog"),
    ...
    fun `should verify test schema exists in Unity Catalog via REST API`() {
        ...
        assertTrue(schemas.contains("sales_data"),
    ...
    fun `should create table in Unity Catalog via REST API`() {
        ...
        val tableCreated = UnityCatalogRestClient.createTable(
            baseUrl = baseUrl,
            catalogName = "test_catalog",
            schemaName = "sales_data",
        ...
        assertTrue(tables.contains("sales_records"),
    ...
    fun `should get table metadata from Unity Catalog via REST API`() {
        ...
        // Get table info
        val tableInfo = UnityCatalogRestClient.getTable(
            baseUrl, "test_catalog", "sales_data", "sales_records"
        )
    ...
    fun `generateCreateSQL should work with Unity Catalog naming`() {
        ...
        val sql = UnityCatalogIntegrator.generateCreateSQL<SalesRecord>(
