...
internal class RowDeserializer<T : Any> private constructor(
    ...
    fun deserialize(row: Row): T {
        ...
        val argsMap =
            parameterExtractors.associate { extractor ->
    ...
    private class ParameterExtractor(
        ...
        fun extract(row: Row): Any? {
            ...
            require(rawValue != null || parameter.type.isMarkedNullable) {
                "Null value received for non-nullable parameter '$paramName'"
            }
        ...
        fun extractByIndex(
            ...
            if (columnIndex < 0) {
                require(parameter.type.isMarkedNullable) {
                    "Column for non-nullable parameter '$paramName' is absent from the schema"
                }
                return null
            }
        ...
        fun <T : Any> create(kType: KType): RowDeserializer<T> {
            ...
            if (objectInstance != null) {
                return RowDeserializer(
                    constructor = null,
                    parameterExtractors = emptyList(),
                    singleton = objectInstance,
                )
            }
            ...
            val extractors =
                constructor.parameters.map { param ->
                    val paramName = getParameterName(kClass, param)
                    val resolvedType = resolveParameterType(kClass, kType, param, argMap)
