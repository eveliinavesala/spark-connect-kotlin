...
private fun sparkTypeToUcTypeName(dt: DataType): String = when (dt) {
...
private fun ucTypeNameToSparkType(typeName: String): DataType = when (typeName.uppercase()) {
